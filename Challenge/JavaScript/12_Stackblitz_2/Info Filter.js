...
// 여기에 코드를 작성하세요
const gmailUsers = NewUsers.filter(function (user) {
...
function renderUserData(userData) {
    ...
    // 여기에 코드를 작성하세요
    userDataDiv.innerHTML = userData.map(function (user) {
        return `<div class="user"> <p><strong>Name:</strong> ${user.name}</p>
        <p><strong>Age:</strong> ${user.age}</p> <p><strong>Email:</strong> ${user.email}</p> </div>`;
    });
}
